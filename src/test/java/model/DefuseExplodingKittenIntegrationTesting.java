...
//		deck.insertCard(domain.game.CardType.CAT_ONE, deckSize, false);
...
//		domain.game.Card explodingKittenCard = game.drawCard();
...
//		Card defuseCard = instantiator.createCard(domain.game.CardType.DEFUSE);
...
//			(Integer index) {
//		assertEquals(domain.game.CardType.EXPLODING_KITTEN, game.getDeckCardType(index));
//	}
//
